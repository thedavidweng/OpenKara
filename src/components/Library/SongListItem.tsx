          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {sepState === "idle" && canSeparateSong && (
              <button
                ...
                className={`pointer-events-auto rounded border px-1.5 py-0.5 text-[10px] disabled:cursor-default disabled:opacity-50 ${
                  isSelected
              ...
              <div className="flex items-center gap-1 text-[11px] text-[var(--color-text-dim)]">
                ...
                {!batchActive && (
                  <button
                    ...
                    className="pointer-events-auto motion-icon-button rounded p-0.5 text-[var(--color-text-dim)] hover:bg-[var(--sidebar-row-overlay-bg)] hover:text-[var(--color-text)]"
                    data-native-overlay-surface="song-action"
                  >
                    <X size={12} />
                  </button>
            ...
            {sepState === "failed" && canSeparateSong && (
              <button
                type="button"
                onClick={handleSeparate}
                className="pointer-events-auto text-[10px] text-[var(--color-destructive)]"
              >
                {t("common.retry")}
              </button>
            )}
