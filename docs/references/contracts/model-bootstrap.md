...
| `cpu_fallback_notice` | `Option<String>`                                                                                                                                                                                                                              | Present when the active runtime is the CPU-only Windows artifact because of a recorded DirectML load timeout (see ADR 0023). Serialized only when non-`None`. |
