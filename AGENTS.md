...
4. If multiple subsystems changed, use the stricter command set.
5. Re-check that any touched docs/config/contracts still match the code.
6. Only then report completion or prepare the change for submission.
