...
pub fn create_playlist(conn: &Connection, name: String) -> CommandResult<Playlist> {
...
pub fn rename_playlist(conn: &Connection, playlist_id: &str, name: &str) -> CommandResult<()> {
    let rows = conn
        .execute(
...
pub fn delete_playlist(conn: &Connection, playlist_id: &str) -> CommandResult<()> {
    let rows = conn
        .execute(
...
pub fn set_rotation_state(conn: &Connection, rotation: &RotationState) -> CommandResult<()> {
...
pub fn get_rotation_state(conn: &Connection) -> CommandResult<RotationState> {
    let mut stmt = conn
        .prepare(
...
pub fn advance_rotation(conn: &mut Connection) -> CommandResult<RotationState> {
